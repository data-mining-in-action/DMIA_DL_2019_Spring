...
2. Создаем окружение для python3.6 командой `conda create -n py36 python==3.6`. Обратите внимание на инструкции в конце установки, там будет написано, [как активировать окружение](https://conda.io/docs/user-guide/tasks/manage-environments.html#activating-an-environment). Если с версией python будут проблемы и не будет испортироваться tensorflow, можно попробовать полечить проблему установив версию python==3.6.1 `conda create -n py36 python==3.6.1`.
